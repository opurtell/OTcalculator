...
/**
 * The desktop shape: inputs left, sticky result right. The preview card is
 * wider than 900px, so this is what it renders — below that breakpoint the
 * same markup stacks, with the result pinned above the scrolling inputs.
 */
